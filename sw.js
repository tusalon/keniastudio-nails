...
const urlsToCache = [
  ...
  '/keniastudio-nails/vendor/react.production.min.js',
  '/keniastudio-nails/vendor/react-dom.production.min.js',
  '/keniastudio-nails/vendor/babel.min.js',
  '/keniastudio-nails/vendor/bcrypt.min.js',
  '/keniastudio-nails/vendor/tailwind-browser.js',
  '/keniastudio-nails/vendor/lucide/lucide.css',
  '/keniastudio-nails/vendor/lucide/lucide.woff2',
  '/keniastudio-nails/utils/push-config.js',
  '/keniastudio-nails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/keniastudio-nails/icons/icon-192x192.png',
    badge: '/keniastudio-nails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/keniastudio-nails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/keniastudio-nails/admin.html';
  event.waitUntil(
